...
class Cgu extends Component {
  render() {
    return (<div>
      <Header/>
      <div className="Cgu Component">
        <p>
          <h1>Conditions générales d'utilisation du site www.cryptoconseils.fr</h1>

          <h2>ARTICLE 1 : Objet</h2>

          <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site www.cryptoconseils.fr et leur utilisation par « l'Utilisateur ».</p>
          ...
          <p>Cryptoconseils.fr se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</p>

          <h2>ARTICLE 2 : Mentions légales</h2>

          <p>L'édition du site CryptoConseils.fr est assurée par la Société CryptoConseils [SAS / SA / SARL, etc.] au capital de 1 € dont le siège social est situé au 242 rue du Faubourg Saint-Antoine, 75012 Paris.</p>

          <p>Le Directeur de la publication est Monsieur LENFANT Valentin.</p>

          <p>Éventuellement :</p>

          <p>CryptoConseils est une société du groupe CryptoConseils [SAS / SA / SARL, etc.] au capital de 1 € dont le siège social est situé au 242 rue du Faubourg Saint-Antoine, 75012 Paris.</p>

          <p>L'hébergeur du site CryptoConseils.fr est la Société phpnet SARL au capital de 3000 € dont le siège social est situé au 97-97 bis rue du Général Mangin 38100 GRENOBLE.</p>
          ...
          <p>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de CryptoConseils.fr.</p>
          ...
          <p>L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse cryptoconseilsfr@gmail.com.</p>
          ...
          <p>par mail à cryptoconseilsfr@gmail.com ;</p>

          <p>par voie postale au 122 rue de Villiers, 92300 Levallois-Perret.</p>
          ...
          <p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de cryptoconseils.fr qui n'a pas le contrôle de ces liens.</p>
