...
class Expert extends Component {
  ...
  renderButton(){
    if(this.props.isAdmin){
      return <button href={ "90.90.185.202:8000/orders/new/500?accessToken=" + this.state.access_token } className="btn btn-primary">COMMANDER</button>
    }else {
      return <button href={ "90.90.185.202:8000/orders/new/500?accessToken=" + this.state.access_token } className="btn btn-primary" disabled>COMMANDER</button>
    }
  }
