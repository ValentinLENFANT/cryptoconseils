...
class Lambo extends Component {
  ...
  renderButton(){
    if(this.props.isAdmin){
      return <button href={ "/orders/new/1000?accessToken=" + this.state.access_token } className="btn btn-primary">COMMANDER</button>
    }else {
      return <button href={ "/orders/new/1000?accessToken=" + this.state.access_token } className="btn btn-primary" disabled>COMMANDER</button>
    }
  }
